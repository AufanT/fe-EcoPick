...
const Footer = () => {
  return (
    <div className="mt-8 bg-[#19583B] pt-9">
        ...
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          ...
          <div className="md:w-[316px]">
            ...
            <div className="mt-[18px] flex gap-4">
              {[
                ...
                <a key={index} className="hover:scale-110" target="_blank" rel="noopener noreferrer" href={item.href}>
                  <img alt={item.alt} width="36" height="36" style={{ color: 'transparent' }} src={item.src} />
                </a>
              ))}
            </div>
          </div>
          ...
          <div className="md:w-[316px]">
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-white">
                  help@lorem.com
                </a>
          ...
          <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
            <div>
              <p className="font-inter text-[18px] font-medium leading-normal">Pages</p>
              <ul>
                {[
                  { text: 'Home', href: '/' },
                  { text: 'News', href: '/our-tutors' },
                  { text: 'Contact', href: '/become-a-tutor' },
                  { text: 'Plans and pricing', href: '/plans-and-pricing' },
                  { text: 'Terms and conditions', href: '/terms-and-conditions' },
                  { text: 'Privacy policy', href: '/privacy-policy' }
                ].map((link, i) => (
                  <li key={i} className="mt-[15px]">
                    <a
                      className="hover:text-white/80 font-inter text-[15px] font-normal hover:font-semibold"
                      href={link.href}
                    >
                      {link.text}
                    </a>
            ...
            <div className="mt-6 flex flex-col gap-4 sm:mt-0">
              <p className="font-inter text-[18px] font-medium">Download the app</p>

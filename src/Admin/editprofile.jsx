...
const EditProfile = () => {
  ...
  // Upload file → simpan ke base64 di formData
          ...
          <main className="flex-1 p-6">
            <div className="flex">
              ...
              <div className="ml-6 flex-1">
                <div className="bg-white shadow-md rounded-2xl p-8 h-80 w-full">
                ...
                <div className="pt-4 items-center">
                  <button
                    ...
                    className="bg-black text-white flex justify-between px-4 py-1 rounded-lg hover:bg-green-700 cursor-pointer"
                  >
                    Save Changes
                  </button>
                </div>
